...
pixel_noise_00 = np.load('data/event_number_analysis_pixel_noise_00.npy')
pixel_noise_05 = np.load('data/event_number_analysis_pixel_noise_05.npy')
pixel_noise_10 = np.load('data/event_number_analysis_pixel_noise_10.npy')
pixel_noise_15 = np.load('data/event_number_analysis_pixel_noise_15.npy')
pixel_noise_20 = np.load('data/event_number_analysis_pixel_noise_20.npy')
timestamp_jitter_00 = np.load(
    'data/event_number_analysis_timestamp_jitter_00.npy')
timestamp_jitter_25 = np.load(
    'data/event_number_analysis_timestamp_jitter_25.npy')
timestamp_jitter_50 = np.load(
    'data/event_number_analysis_timestamp_jitter_50.npy')
timestamp_jitter_75 = np.load(
    'data/event_number_analysis_timestamp_jitter_75.npy')
timestamp_jitter_100 = np.load(
    'data/event_number_analysis_timestamp_jitter_100.npy')
angular_velocity_disturbance_00 = np.load(
    'data/event_number_analysis_angular_velocity_disturbance_00.npy')
angular_velocity_disturbance_25 = np.load(
    'data/event_number_analysis_angular_velocity_disturbance_25.npy')
...
angular_velocity_disturbance_75 = np.load(
    'data/event_number_analysis_angular_velocity_disturbance_75.npy')
angular_velocity_disturbance_100 = np.load(
    'data/event_number_analysis_angular_velocity_disturbance_100.npy')

# --------------------------------------------------------------------------- #
# Visualization Choice
# --------------------------------------------------------------------------- #

colors = ['#C34129', '#EFB758', '#A7C584', '#6B84A7', '#E2DBC9']
...
plt.ylim([-0.5, 32])  # pixel noise
# plt.ylim([-0.5, 12])  # time jitter
# plt.ylim([-0.5, 16])  # gyro noise
plt.legend(handles=legend_handles, loc='upper right', fontsize=(font_size-4))
plt.axhline(y=0, color='r', linestyle='--', linewidth=1)
plt.grid(axis='y')
plt.tight_layout()
plt.savefig("/home/oem/Videos/sim_event_number_analysis_pixel_noise.pdf",
            bbox_inches='tight', format='pdf')
# plt.savefig("/home/oem/Videos/sim_event_number_analysis_time_jitter.pdf",
#             bbox_inches='tight', format='pdf')
# plt.savefig("/home/oem/Videos/sim_event_number_analysis_gyro_noise.pdf",
#             bbox_inches='tight', format='pdf')
plt.show()
